...
public class ProductRepositoryCustomImpl implements ProductRepositoryCustom {
    ...
    public List<ProductDTO> findProductsSortedByName(String categoryName, Integer page, Integer size) {
        return em.createQuery("select new com.filot.filotshop.product.entity.ProductDTO (p.id, p.name, p.price, p.size, p.imageUrl,p.amount) " +
    ...
    public List<ProductDTO> findProductsSortedByPriceDESC(String categoryName, Integer page, Integer size) {
        return em.createQuery("select newcom.filot.filotshop.product.entity.ProductDTO (p.id, p.name, p.price, p.size, p.imageUrl,p.amount) " +
